...
export const TEMPLATE_CHROME = {
  'modern-minimal': {
    ...
    headerClassName: 'sticky top-0 z-40 bg-white/85 backdrop-blur-xl flex items-center justify-between px-4 sm:px-6 lg:px-8 py-4 sm:py-6 border-b border-gray-100',
    logoClassName: '',
  ...
  'bold-boutique': {
    ...
    headerClassName: 'sticky top-0 z-40 bg-black/80 backdrop-blur-xl border-b border-white/10 flex items-center justify-between px-4 sm:px-6 lg:px-8 py-4 sm:py-6',
  ...
  'grocery-fresh': {
    ...
    headerClassName: 'sticky top-0 z-40 flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 text-white shadow-soft',
  ...
  'fashion-editorial': {
    ...
    headerClassName: "sticky top-0 z-40 bg-[#f8f6f2]/90 backdrop-blur-xl px-4 sm:px-6 lg:px-8 py-4 sm:py-6",
  ...
  'electronics-tech': {
    ...
    headerClassName: 'sticky top-0 z-40 bg-slate-950/85 backdrop-blur-xl flex items-center justify-between px-4 sm:px-6 lg:px-8 py-4 sm:py-5 border-b',
